...
class EncoderLayer4AST(nn.Module):
	...
	def forward(self, hidden_states, attention_mask, hidden_states_ent, attention_mask_ent, input, hidden, cell_state, ent_mask=None):
		hidden_states, hidden_states_ent = hidden_states, hidden_states_ent
		hidden_states.size()
		...
		# TODO
		# hidden_states_ent = hidden_states_ent  # * ent_mask
		x, ent, output = self.sublayer(hidden_states, hidden_states_ent, updated_hidden)
